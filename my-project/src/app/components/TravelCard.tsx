...
// import { PlaneIcon, StarIcon, Sun01Icon } from "@hugeicons/core-free-icons";
...
// // Estimated anchor points (button icon center -> chip icon center),
// // joined by a single quadratic curve that arcs up and over.
// const FLIGHT_PATH = "M 286 510 Q 240 320 295 328";
...
//             duration: 0.02,
//             ease: "easeOut",
//             delay: expanded ? 0 : 0.35,
//           },
//         }}
//         className="absolute inset-0 overflow-hidden rounded-[40px] shadow-xl"
//       >
//         {/* Image */}
//         <motion.div
//           animate={{
...
//           transition={{ ...morph, duration: expanded ? 0.15 : 0.08 }}
...
//               <h3 className="text-lg font-semibold tracking-tight text-balance text-[oklch(0.215_0.029_243.425)]">
//                 Deep Blue Nights
//               </h3>

//               {/* Seats chip — the plane badge lands here (see the flying
//                   plane element below), so no icon is rendered here directly. */}
//               <span className="flex shrink-0 items-center gap-1.5 rounded-full bg-[oklch(0.956_0.004_236.498)] py-1 ps-1 pe-3 text-xs font-medium text-[oklch(0.215_0.029_243.425)] tabular-nums">
//                 <span className="h-4 w-4 shrink-0" />9 seats left
//               </span>
//             </div>
//           </motion.div>
...
//           >
//             For those who crave peace louder than the city. This view isn’t just
//             scenery, it’s a whole reset.
//           </motion.p>
...
//               duration: 0.12,
//               ease: "easeOut",
//               delay: expanded ? 0.16 : 0,
//             }}
//             className="mt-3 flex items-center gap-2"
//           >
//             <span className="rounded-[20px] bg-[oklch(0.956_0.004_236.498)] px-3 py-1 text-sm font-medium text-[oklch(0.215_0.029_243.425)] tabular-nums">
//               $2,999
//             </span>
//             <span className="flex items-center gap-1 rounded-[20px] bg-[oklch(0.956_0.004_236.498)] px-3 py-1 text-xs font-medium text-[oklch(0.215_0.029_243.425)]">
//               <HugeiconsIcon
//                 icon={Sun01Icon}
//                 size={12}
//                 strokeWidth={2}
...
//         {/* CTA — button morphs into full-width Add to Cart */}
//         <motion.button
//           type="button"
//           onClick={toggle}
...
//         >
//           {/* Icon spacer — the plane badge lands here visually (see the
//               flying plane element below), so no icon is rendered here directly. */}
//           {!expanded && <span className="h-6 w-6 shrink-0" />}

//           {/* Text swaps in its own popLayout AnimatePresence so it's
//               never queued behind the icon's exit — it reacts the
//               instant the button starts expanding instead of waiting. */}
...
//         {/* The only plane icon on the card — travels along a curved path
//             between the button and the chip and stays visible at rest at
//             either end. Keyed by stage so each toggle is a fresh mount,
//             guaranteeing the offsetDistance/scale animation always replays. */}
//         <AnimatePresence>
//           <motion.span
//             key={stage}
//             aria-hidden
...
//                   },
//             }}
//             className="absolute flex h-4 w-4 items-center justify-center rounded-full bg-[oklch(0.215_0.029_243.425)]"
//           >
//             <HugeiconsIcon
//               icon={PlaneIcon}
//               size={12}
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <h3 className="line-clamp-2 min-w-0 text-lg font-semibold tracking-tight text-balance text-[oklch(0.215_0.029_243.425)]">
                {title}
              </h3>
