...
export default function FrostedModal() {
  return (
    <div className="h-28 w-64 overflow-y-auto">
      <header className="sticky top-0 z-2 w-full p-4">
        <div
          className="pointer-events-none absolute inset-0 h-[200%] backdrop-blur-[8px]"
          style={{
            maskImage:
        ...
        />
        <div
          className="pointer-events-none absolute inset-0 h-full translate-y-full bg-white/10 backdrop-blur-[1px] backdrop-brightness-125"
          style={{
            maskImage:
