  ...
  ({ className, children, speedMs = 3000, style, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "relative inline-flex items-center justify-center rounded-[8px] border border-solid border-transparent px-[10px] py-[10px] text-[12px] leading-none font-normal text-white transition-transform outline-none active:scale-[0.98]",
          className,
        )}
        style={{
          fontFamily:
